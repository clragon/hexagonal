...
```html
<script type="module" src="https://libs.cdn.clynamic.net/hexagonal/0.3.1/hexagonal.min.js"></script>
...
```html
<link rel="stylesheet" href="https://libs.cdn.clynamic.net/hexagonal/0.3.1/hexagonal-tokens.css" />
<link rel="stylesheet" href="https://libs.cdn.clynamic.net/hexagonal/0.3.1/hexagonal-preflight.css" />
...
```html
<link rel="stylesheet" href="https://libs.cdn.clynamic.net/hexagonal/0.3.1/hexagonal-fonts.css" />
```
